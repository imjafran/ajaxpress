<div class="wrap">
    <div class="ap_settings_form" id="ap_settings_form">
        <?php screen_icon(); ?>
        <h2>AjaxPress Settings</h2>
        <form method="post" action="options.php">
            <?php
            settings_fields('ap_options_group');
            ?>

            <div class="form-group">
                <label for="ap_enable">Enable Ajax Loading</label>
                <input type="checkbox" id="ap_enable" name="ap_enable" <?php echo get_option('ap_enable') == true ? 'checked' : ''; ?> />
            </div>


            <div class="form-group">
                <label for="ap_search">Enable Ajax Search</label>
                <input type="checkbox" id="ap_search" name="ap_search" <?php echo get_option('ap_search') == true ? 'checked' : ''; ?> />
            </div>

            <div class="form-group">
                <label for="ap_comment">Enable Ajax Comment</label>
                <input type="checkbox" id="ap_comment" name="ap_comment" <?php echo get_option('ap_comment') == true ? 'checked' : ''; ?> />
            </div>

            <div class="form-group">
                <label for="ap_selector">HTML Selector</label>
                <input placeholder="Wrapper Selector" type="text" id="ap_selector" name="ap_selector" value="<?php echo get_option('ap_selector'); ?>" />
            </div>
            ...
            <div class="form-group">
                <label for="ap_loading">Loading Message</label>
                <textarea name="ap_loading" placeholder="Type message while loading the page" id="ap_loading" rows="3"><?php echo get_option('ap_loading'); ?></textarea>
        ...
        <footer>
            ...
            <div class="icons">
                <a href="https://github.com/imjafran" target="_blank">
                    <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                        <path fill="blue" d="m75 512h167v-182h-60v-60h60v-75c0-41.355469 33.644531-75 75-75h75v60h-60c-16.542969 0-30 13.457031-30 30v60h87.292969l-10 60h-77.292969v182h135c41.355469 0 75-33.644531 75-75v-362c0-41.355469-33.644531-75-75-75h-362c-41.355469 0-75 33.644531-75 75v362c0 41.355469 33.644531 75 75 75zm-45-437c0-24.8125 20.1875-45 45-45h362c24.8125 0 45 20.1875 45 45v362c0 24.8125-20.1875 45-45 45h-105v-122h72.707031l20-120h-92.707031v-30h90v-120h-105c-57.898438 0-105 47.101562-105 105v45h-60v120h60v122h-137c-24.8125 0-45-20.1875-45-45zm0 0" />
                    </svg>
                </a>
                <a href="https://facebook.com/iamjafran" target="_blank">
                    <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://linkedin.com/iamjafran" target="_blank">
                    <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
